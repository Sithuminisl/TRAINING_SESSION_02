...
set rc [catch {
  ...
  set_param synth.incrementalSynthesisCache C:/INTERNSHIP_2/TRAINING/four_bit_ALU_unit/work1/ALU_design/.Xil/Vivado-17652-Sithu-laptop/incrSyn
  create_project -in_memory -part xc7vx485tffg1157-1
  set_property design_mode GateLvl [current_fileset]
  set_param project.singleFileAddWarning.threshold 0
  set_property webtalk.parent_dir C:/INTERNSHIP_2/TRAINING/four_bit_ALU_unit/work1/ALU_design/ALU_design.cache/wt [current_project]
  set_property parent.project_path C:/INTERNSHIP_2/TRAINING/four_bit_ALU_unit/work1/ALU_design/ALU_design.xpr [current_project]
  set_property ip_output_repo C:/INTERNSHIP_2/TRAINING/four_bit_ALU_unit/work1/ALU_design/ALU_design.cache/ip [current_project]
  set_property ip_cache_permissions {read write} [current_project]
  add_files -quiet C:/INTERNSHIP_2/TRAINING/four_bit_ALU_unit/work1/ALU_design/ALU_design.runs/synth_1/alu.dcp
