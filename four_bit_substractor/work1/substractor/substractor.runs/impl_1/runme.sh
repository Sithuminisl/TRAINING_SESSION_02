...
HD_PWD='C:/INTERNSHIP_2/TRAINING/four_bit_substractor/work1/substractor/substractor.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbit_substractor.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source fourbit_substractor.tcl -notrace
