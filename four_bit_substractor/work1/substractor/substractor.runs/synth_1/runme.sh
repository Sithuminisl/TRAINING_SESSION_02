...
HD_PWD='C:/INTERNSHIP_2/TRAINING/four_bit_substractor/work1/substractor/substractor.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log fourbit_substractor.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source fourbit_substractor.tcl
