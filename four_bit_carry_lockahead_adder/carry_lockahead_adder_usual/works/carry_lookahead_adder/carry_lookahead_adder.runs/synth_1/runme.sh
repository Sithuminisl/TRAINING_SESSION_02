...
HD_PWD='C:/INTERNSHIP_2/TRAINING/four_bit_carry_lockahead_adder/carry_lockahead_adder_usual/works/carry_lookahead_adder/carry_lookahead_adder.runs/synth_1'
cd "$HD_PWD"
